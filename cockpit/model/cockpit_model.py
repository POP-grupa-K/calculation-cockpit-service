...
class CockpitModel(Base):
    ...
    def __init__(self, name, reserved_credits, id_app, id_user, status):
        self.name = name
    ...
    def from_schema(cls, cockpit_schema: cockpit_schema.CockpitSchema):
        return cls(cockpit_schema.name, cockpit_schema.reservedcredits, cockpit_schema.idapp, cockpit_schema.iduser, cockpit_schema.status)
