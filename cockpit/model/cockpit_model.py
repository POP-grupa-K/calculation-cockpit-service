...
class CockpitModel(Base):
    ...
    def __init__(self, idtask, name, reservedcredits, idapp):
        self.id_task = idtask
        self.name = name
    ...
    def from_schema(cls, cockpit_schema: cockpit_schema.CockpitSchema):
        return cls(cockpit_schema.idtask, cockpit_schema.name, cockpit_schema.reservedcredits, cockpit_schema.idapp)
